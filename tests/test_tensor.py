from minitorch import grad_check, tensor, make_tensor_backend, TensorOps
import pytest
from hypothesis import given
from hypothesis.strategies import lists, data, permutations, integers
from .strategies import tensors, shaped_tensors, assert_close, small_floats, assert_close_tensor
from minitorch import MathTestVariable

one_arg, two_arg, red_arg = MathTestVariable._tests()

TensorBackend = make_tensor_backend(TensorOps)
shared = {"backend": TensorBackend}
matmul_tests = [pytest.param("backend", marks=pytest.mark.task3_2)]
